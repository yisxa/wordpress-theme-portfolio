        ...
        <section class="portfolio-block photography">
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-md-6 col-lg-4 item zoom-on-hover"><a href="#"><img class="img-fluid image" src="<?php echo get_theme_file_uri('/assets/img/nature/image5.jpg'); ?>"></a></div>
                    <div class="col-md-6 col-lg-4 item zoom-on-hover"><a href="#"><img class="img-fluid image" src="<?php echo get_theme_file_uri('/assets/img/nature/image2.jpg'); ?>"></a></div>
                    <div class="col-md-6 col-lg-4 item zoom-on-hover"><a href="#"><img class="img-fluid image" src="<?php echo get_theme_file_uri('/assets/img/tech/image4.jpg'); ?>"></a></div>
                     <div class="col-md-6 col-lg-4 item zoom-on-hover"><a href="#"><img class="img-fluid image" src="<?php echo get_theme_file_uri('/assets/img/nature/image5.jpg'); ?>"></a></div>
                    <div class="col-md-6 col-lg-4 item zoom-on-hover"><a href="#"><img class="img-fluid image" src="<?php echo get_theme_file_uri('/assets/img/nature/image2.jpg'); ?>"></a></div>
                    <div class="col-md-6 col-lg-4 item zoom-on-hover"><a href="#"><img class="img-fluid image" src="<?php echo get_theme_file_uri('/assets/img/tech/image4.jpg'); ?>"></a></div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12 col-lg-5">
                    <div class="portfolio-laptop-mockup">
                        <div class="screen">
                            <div class="screen-content" style="background-image:url(&quot;<?php echo get_theme_file_uri('/assets/img/tech/image6.png'); ?>&quot;);"></div>
                        </div>
